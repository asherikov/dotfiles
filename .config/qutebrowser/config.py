...
# AS:
#   - common clients: https://microlink.io/user-agents
#   - this is not enough: https://browserleaks.com/client-hints, https://github.com/qutebrowser/qutebrowser/issues/6464
#c.content.headers.user_agent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36'
...
config.bind('s', 'cmd-set-text :set content.proxy socks://localhost:9050/')
...
config.bind('d', 'nop')
config.bind('S', 'cmd-set-text -s :open duck')
config.bind('D', 'cmd-set-text -s :open dict')
config.bind('T', 'cmd-set-text -s :open thes')
config.bind('<F1>', ':open file:///home/aleks/git/local/www_local/html/index.html')
